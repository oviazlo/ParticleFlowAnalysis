...
// vector<string> energyFillCollections = {"ECalBarrelCollection", "ECalEndcapCollection","HCalBarrelCollection", "HCalEndcapCollection"};
...
int main (int argn, char* argv[]) {
	...
	energyFillAllCalo* tmpEnergyFillAllCalo = new energyFillAllCalo("AllCalo");
	objFillMap["AllCalo"] = tmpEnergyFillAllCalo;
	...
	desc.add_options()
		...
		("outFileName,o", po::value<string>(), "output file name")
		("debug,d", "debug flag")
		;
	...
	string outFileName = "overlayAnalysis";
	if (vm.count("outFileName"))
		outFileName = vm["outFileName"].as<string>();
